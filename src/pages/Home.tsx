...
import { getWorks, incrementView } from '../data';
      ...
      <main className="max-w-7xl mx-auto px-4 py-16 space-y-20">
        ...
        <section className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="bg-gradient-to-br from-blue-700 to-blue-900 rounded-3xl shadow-xl p-8 text-white relative overflow-hidden flex flex-col justify-center">
            ...
            <button 
              onClick={() => {
                const recipient = 'dzakygiovani@gmail.com';
                const subject = encodeURIComponent('Pengajuan Karya LIVO - [Judul Karya]');
                const body = encodeURIComponent('Halo Admin LIVO,\n\nSaya ingin mengajukan karya saya untuk dipublikasikan di platform LIVO.\n\nDetail Karya:\n- Judul:\n- Jenis (Komik/Novel):\n- Deskripsi Singkat:\n\nTerima kasih.');
                const gmailUrl = `https://mail.google.com/mail/?view=cm&fs=1&to=${recipient}&su=${subject}&body=${body}`;
                window.open(gmailUrl, '_blank');
              }}
              className="bg-orange-500 hover:bg-orange-600 text-white px-6 py-3.5 rounded-xl font-bold text-sm w-full transition-all relative z-10 shadow-lg shadow-orange-500/20 flex justify-center items-center"
            >
